    ...
    export default {
        ...
        methods: {
                ...
                Swal.fire(this.datasweetalert()).then(result => {
                    if (result.value) {
                        if ("id" in self.despachos[index]) {
                            axios
                                .delete(
                                    `/sistema/despacho/delete/${self.despachos[index].id}`
                                )
                                .then(response => {
            ...
            getAutocompleteEmpleadoReemplazo: function () {
                ...
                var options = {
                    url: function (criterio) {
                        return `/api/bansis/nominas/rrhh/empleados/${criterio}`;
                    },
                    getValue: "nombre",
                    ajaxSettings: {
                        method: "GET",
            ...
            getAutocompleteProducto: function () {
                ...
                var options = {
                    url: function (criterio) {
                        ...
                        return `/api/xass/productos/${bodega}/${criterio}`;
                    },
                    getValue: "nombre",
                    template: {
                        type: "description",
            ...
            getDataEmpleado: function (empleado, semana, hacienda) {
                ...
                if (empleado != null) {
                    axios
                        .get(`/sistema/despacho/data/${empleado}/${semana}/${hacienda}/1`)
                        .then(response => {
                            if (response.data) {
            ...
            getSaldoPendienteEmpleado: function (idempleado, idmaterial, semana) {
                ...
                axios
                    .get(
                        `/api/bansis/enfunde/saldo_empleado/${idempleado}/${idmaterial}/${semana}`
                    )
                    .then(response => {
                        if (response.data) {
